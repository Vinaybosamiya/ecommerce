<?php require('top.php');
// require('Admin/USER_ADMIN_PANLE/slider2.php');
?>

<?php include('function.php');
$get_img = "select * from letest_product_img";
$res = mysqli_query($conn,$get_img);
$sql = "SELECT * FROM product WHERE best_product = 1 limit 4";
...
<div class="wrapper">
    ...
    <div class="slider__container slider--one bg__cat--3">
        <div class="slide__container slider__activation__wrap owl-carousel">
            <?php
$dir = "/ecommerce/Admin/USER_ADMIN_PANLE/Letest_Product_Img/images/";
...
?>
<div class="slider__fixed--height">
  <div class="container-fluid" style="padding:0;">
    <div class="row no-gutters">
      <div class="col-12">
        <div class="slide__thumb">
                             <img src="<?php echo $dir . $row['letestProduct_img'] ?>" alt="slider images" class="slider-img">
        </div>
      </div>
    </div>
  </div>
...
?>
                    ...
                    <div class="product__list clearfix mt--30"> -->
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-lg-4 col-sm-6 col-xs-6">
                                <!-- style=" height: 257px; width: 1000px; margin-bottom: 4px; -->
                                <div class="category">
    ...
    <!-- <section class="htc__good__sale bg__cat--3 " style="margin-top: 150px;">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="section__title--2 text-center">
                        ...
                        <h2 class="title__line">Best Selling Product</h2>
            ...
            <!-- <div class="row"> -->
                    <div class="product__list clearfix mt--30">
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            // $sql = "SELECT * FROM product WHERE best_product = 1 AND id = $products[id]";
                        ?>
                            <!-- Start Single Category -->
                            <div class="col-md-6 col-lg-4 col-sm-6 col-xs-6">
                                <!-- style=" height: 257px; width: 1000px; margin-bottom: 4px; -->
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product.php?id=<?php echo $row['id']; ?>">
                                            ...
                                            <?php $img = PRODUCT_IMAGE_SITE_PATH . $row["image"]; ?>
                                            <img src="<?php echo $img; ?>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
...
.slider__fixed--height {
    width: 100vw;
    min-height: 400px;          /* Increase min-height for a bigger image area */
    overflow: hidden;
    background: #fff;
}
.slide__thumb {
    width: 100%;
    height: 70vh;               /* Increase height for a larger image */
    min-height: 400px;
    max-height: 900px;
    display: flex;
    align-items: center;
...
.slider-img {
    width: auto;                /* Allow width to auto-scale based on height */
    max-width: 100%;
    height: 100%;               /* Make image as tall as container */
    object-fit: contain;        /* Entire image always visible, no cropping */
    background: #fff;
    display: block;
    margin: 0 auto;
}
@media (max-width: 768px) {           /* Adjusts for mobile devices */
    .slide__thumb {
        height: 60vw;                 /* Make slider a bit taller on phones */
        min-height: 200px;
        max-height: 400px;
    }
